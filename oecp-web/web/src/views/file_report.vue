<template>
  ...
  export default {
      ...
      mounted() {
          ...
          if(this.$route.query){
            self.search.category_level = this.$route.query.level
            if(this.$route.query.c_result=='same'){
                self.search.compare_result = ['same', 'change']
            } else {
                self.search.compare_result = [this.$route.query.c_result]
            }
            self.search.compare_type = this.$route.query.c_type
          }
